...
public class ResultGenerator {
    ...
    private String[][] getData(List<User> userList) {
        ...
        for (User user : userList){
            ...
            goalsString = statusGoals + myFormatGoals2(goalsString); // Форматируем строку целей
            ...
            results = !results.equals(defaultResult) ? statusResults + myFormatGoals2(results) : "";
            // Добавляем данные в массив
            data[row][0] = username;
            data[row][1] = goalsString;
            data[row][2] = results;
    ...
    private static String myFormatGoals(String sss) {
        int n = 2;
        int m = 6;
    ...
    private static String myFormatGoals2(String sss) {
    ...
    private static void customizeTable(JTable table) {
        ...
        Font cellFont = new Font("Serif", Font.BOLD, 22);
        ...
        table.getColumnModel().getColumn(2).setMinWidth(850);
